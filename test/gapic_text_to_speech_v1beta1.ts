...
describe('v1beta1.TextToSpeechClient', () => {
    ...
    describe('listVoices', () => {
        it('invokes listVoices without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.texttospeech.v1beta1.ListVoicesRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.texttospeech.v1beta1.ListVoicesResponse());
        ...
        it('invokes listVoices with error', async () => {
            ...
            await assert.rejects(async () => { await client.listVoices(request); }, expectedError);
            assert((client.innerApiCalls.listVoices as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('synthesizeSpeech', () => {
        it('invokes synthesizeSpeech without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.texttospeech.v1beta1.SynthesizeSpeechResponse());
        ...
        it('invokes synthesizeSpeech with error', async () => {
            ...
            await assert.rejects(async () => { await client.synthesizeSpeech(request); }, expectedError);
            assert((client.innerApiCalls.synthesizeSpeech as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
